...
directiveapp.controller('mdcDatePickerInputController', function ($scope, $attrs, $timeout, $mdDialog) {
    if (angular.isDefined($scope.model)) {
      $scope.selected = {
        model: moment($scope.model).format('LL'),
        date: $scope.model
...
directiveapp.directive('mdDatePickerNew', function () {
    return {
      restrict: 'AE',
