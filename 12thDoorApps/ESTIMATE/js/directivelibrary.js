...
*/	  
	...
	directiveLibraryModule.directive('sectionTitle', function() {
	  return {
		restrict: 'E',
		template: "<div flex='5'>	<img src={{catogeryLetter}} style='margin-top:22px;border-radius:20px'/>	</div> <div flex='20' style='margin-top:35px;'>	<label style='font-weight:700'>{{title}}</label> </div>",
		scope:{
			title:'@',
			catogeryLetter:'='
		},
