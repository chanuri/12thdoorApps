...
.controller('viewCtrl', function($scope,$mdBottomSheet,$interval, $mdDialog, $state, $objectstore, recurringInvoiceService, $window, $stateParams, $rootScope,invoiceDetails, InvoiceService, $filter, $state, $location, UploaderService) {
      ...
      $scope.changeTab = function(ind){
         ...
         name: "Date",id: "Startdate",divider: false
      }, {
         name: "Invoice No",id: "invoiceNo",divider: false
      }, {
         name: "Customer",id: "Name",divider: false
      }, {
         name: "Final Amount",id: "finalamount",divider: false
      }, {
         name: "Balance",id: "balanceDue", divider: false
      }, {
         name: "Due Date",id: "duedate",divider: true
      }, {
         name: "Draft",id: "Draft",divider: false
      }, {
         name: "Paid",id: "Paid",divider: false
      }, {
         name: "Unpaid",id: "Unpaid",divider: false
      },{
         name: "Overdue",id: "Overdue",divider: false
      },{
         name: "Partially Paid",id: "Partially Paid",divider: false
      },{
         name: "Cancelled",id: "Cancelled",divider: false
      }]
...
$scope.cancelStatus = function(obj, ev) {
  var confirm = $mdDialog.confirm()
      ...
      $scope.EditInvoice = function(InvoItem){
        ...
        invoiceDetails.setArray(InvoItem);
        $state.go('edit', {'invoiceno': InvoItem.invoiceNo})
      }
...
$scope.showListBottomSheet = function($event,item) {
    $scope.alert = '';
    $mdBottomSheet.show({
  ...
  // }
   ...
   //--------------------------------------------------------------------------------------------------------------
   //--------------------------------------------------------------------------------------------------------------
  .controller('ListBottomSheetCtrl', function($scope, $mdBottomSheet, $rootScope, invo) {
    $scope.test = invo;
